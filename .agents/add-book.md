...
Read `.agents/conventions.md` first for templates and tag conventions.
...
- [ ] **Reading List.md** — add the book to the appropriate tier/section in `vault/Reading List.md`
  - Format: `- [[books/Title|Title]] - [[authors/Author|Author]]`
- [ ] **Knowledge map** — update `.agents/knowledge-map.md`:
  - Add the book to the adjacency list with its connections
