...
Curated journeys through 4-6 books each. Pick the path that matches your current goal.

---

## The BDD Path

_From test frustrations to living documentation._

1. [[books/Test-Driven Development By Example]] -- understand what BDD improves on
2. [[books/Introducing BDD]] -- the origin: from TDD to behavior
3. [[books/Specification by Example]] -- the broader pattern
4. [[books/BDD in Action]] -- the hands-on toolkit
5. [[books/Writing Effective Use Cases]] -- the use case tradition BDD evolved from

**You'll understand**: why BDD exists, how it differs from TDD, and how to actually do it.

---

## The Architecture Path

_From patterns to boundaries to microservices._
...
_From "afraid to touch it" to "confident to change it."_

1. [[books/Working Effectively with Legacy Code]] -- get untested code under test
2. [[books/The Mikado Method]] -- sequence large changes safely with dependency graphs
3. [[books/Refactoring]] -- improve structure safely
4. [[books/Tidy First]] -- decide when refactoring is worth it
5. [[books/Clean Code]] -- what the code should look like after

**You'll understand**: how to take a messy codebase and incrementally make it better.

---

## The Craft Path

_Becoming a professional software developer._
...
_The intellectual bedrock. Dense but timeless._

1. [[books/The Mythical Man-Month]] -- why software is hard
2. [[books/A Discipline of Programming]] -- formal thinking
3. [[books/Design Patterns]] -- the pattern vocabulary
4. [[books/A Pattern Language]] -- where patterns came from

**You'll understand**: the deep foundations that every modern practice is built on.

---

## The Agile Path

_From manifesto to methodology._

1. [[books/Extreme Programming Explained]] -- the original methodology
2. [[books/Agile Software Development The Cooperative Game]] -- the theory
3. [[books/Planning Extreme Programming]] -- the planning practices
4. [[books/Clean Agile]] -- back to basics
5. [[books/BDD in Action]] -- agile requirements in practice

**You'll understand**: what agile actually means (vs. what it's become) and how to practice it.
